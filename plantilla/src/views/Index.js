  ...
  return (
    <>
      ...
      {/* <section className="py-20 bg-blueGray-600 overflow-hidden">
        ...
        <section className="pt-20 pb-48" id="quienSomos">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                <h2 className="text-4xl font-semibold">Quienes Somos</h2>
                <p className="text-lg leading-relaxed m-4 text-blueGray-500">
                  Somos un equipo de profesionales enfocados en mejorar y facilitar los procesos de comunicacion entre la comunidad publico privada.
                </p>
              </div>
            </div>
            <div className="flex flex-wrap">
        ...
        <section className="relative block py-24 lg:pt-0 bg-blueGray-800" id="contactenos">
          <div className="container mx-auto px-4">
